...
public interface AsyncNamedLock<T> {
   ...
   * <p>
   * The {@link AsyncLock.LockToken} held by the returned future is used to release the lock after it has been
   ...
   * <p>
   * The {@link AsyncLock.LockToken} held by the returned Optional is used to release the lock after it has
