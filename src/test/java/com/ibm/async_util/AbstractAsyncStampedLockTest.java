...
import com.ibm.async_util.AsyncStampedLock.Stamp;
...
public abstract class AbstractAsyncStampedLockTest extends AbstractAsyncReadWriteLockTest {
  ...
  public void testOptimism() {
    ...
    final ReadLockToken readLockToken = TestUtil.join(asl.acquireReadLock());
    ...
    final CompletableFuture<WriteLockToken> writeLock = asl.acquireWriteLock().toCompletableFuture();
    ...
    final WriteLockToken writeLockToken = TestUtil.join(writeLock);
